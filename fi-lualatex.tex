...
In the first chapter, I describe currently available applications that are trying to solve this task, their main features and drawbacks.

In the second chapter, I provide an overview of techniques used for data extraction from images.

The next chapter is concerned with choosing target platforms for which the application should be developed. 
...
An essential part of the thesis is testing and continuous integration. The types of testing that were used to ensure the high quality and reliability of the application are described in the sixth chapter.
