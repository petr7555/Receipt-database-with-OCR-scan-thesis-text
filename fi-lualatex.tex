...
\newcommand{\code}[1]{\mintinline[]{jsx}|#1|} % TODO change to jsx and compile locally using 'latexmk -lualatex --shell-escape fi-lualatex.tex' for jsx syntax support (https://tex.stackexchange.com/a/519333)
...
The seventh chapter describes the implementation and functionality of the application. It shows how Microsoft Form Recognizer~\cite{WhatIsFormRecognizer} was used to extract the information from a receipt photo. This chapter also includes a description of a receipt item categorization using word embeddings. The image processing using the OpenCV\footnote{\url{https://opencv.org/}} library is featured as well. 
...
\begin{enumerate}
    ...
    \newpage
    \item \textbf{Preparing the underlying picture}
